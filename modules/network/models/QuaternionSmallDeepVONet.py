...
class QuaternionSmallDeepVONet(nn.Module):
    def __init__(self, input_size_LSTM, hidden_size_LSTM):
        ...
        self.block3 = QuatC_Block(48, 96, kernel_size=(5, 5), stride=(2, 2),
                               padding=(2, 2), dropout_rate=0.2)
        self.block4 = QuatC_Block(96, 192, kernel_size=(3, 3), stride=(2, 2),
                               padding=(1, 1), dropout_rate=0.2)
        self.block5 = QuatC_Block(192, 192, kernel_size=(3, 3), stride=(2, 2),
                               padding=(1, 1), dropout_rate=0.2)
        self.block6 = QuatC_Block(192, 384, kernel_size=(3, 3), stride=(2, 2),
                               padding=(1, 1), dropout_rate=0.2)
